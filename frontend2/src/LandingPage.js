    ...
    <Box sx={{ bgcolor: 'black', color: 'white', minHeight: '100vh' }}>
      ...
      <Container sx={{ py: 8 }}>
        ...
        <Grid container spacing={4}>
          {[
            { name: 'John Doe', testimonial: 'CloudVision has revolutionized the way I approach my academic research. The insights are incredibly detailed and useful.' },
      ...
      <Footer>
        <Typography variant="body1">
          &copy; 2024 CloudVision. All rights reserved.
        </Typography>
        <Box sx={{ mt: 2 }}>
